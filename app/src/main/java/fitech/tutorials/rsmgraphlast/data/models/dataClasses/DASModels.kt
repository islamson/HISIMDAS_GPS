...
data class DASInput(
    ...
    @SerializedName("tracklineDirection") val tracklineDirection: Int = 0,
    ...
    @SerializedName("useStaticCoastingProfile") val useStaticCoastingProfile: Boolean = false
)
...
data class DASOutput(
    ...
    val coastingRegion: List<CoastingData> = emptyList(),
